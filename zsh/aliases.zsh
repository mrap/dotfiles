...
alias gcp='git cp'
alias ga='git add -A'
alias gaa='git add -A --intent-to-add'
alias gap='git add -p'
alias gaap='git add -A --intent-to-add && git add -p'
...
alias gll='git twoline'
alias gltop='git --no-pager twoline -10'
alias glog='git log'
alias gla='g la'
alias gla2='g la2'
alias glf='g log-history'
alias glnp='g log-not-pushed'
alias gln='gl -n'
alias co='git co'
alias gf='git fetch'
